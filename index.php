...
<section class="testimonial pt-50 pb-50">
    <div class="container">
        <span class="section-suptitle text-center"> Testimonial
        </span>
        <h2 class="section-title sep-type-2 text-center text-white">
            Happy Clients
        </h2>
                    ...
                    <div class="item">
                        <div class="shadow-class row">
                            <div class="col-lg-12 col-md-6">
                                ...
                                <div class="profile1">
                                    <p> Nunc ullamcorper augue nec accumsan
                                        porta. Ut lacinia fgiat viverra. Ut dictum
                                        turpis in ipsum sagittis finibus.</p>
...
<section id="newsletter" class="pt-5 pb-5">
